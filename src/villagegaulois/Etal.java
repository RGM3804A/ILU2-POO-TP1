...
public class Etal {
	...
	public String acheterProduit(int quantiteAcheter, Gaulois acheteur) throws IllegalArgumentException, IllegalStateException{
		if(quantiteAcheter < 1) {
			throw new IllegalArgumentException("La Quantité à acheter doit être supérieure à 1"); //+ quantiteAcheter + 
		}if(!isEtalOccupe()) {
			throw new IllegalStateException("Cet étal n'est pas occupé.");
		}
		StringBuilder chaine = new StringBuilder("");
		try {
